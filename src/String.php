 ...
 * @method static bool startsWith(string $subject,string $substring,bool $caseSensitive) Returns true if the string begins with $substring, false otherwise. By default, the comparison is case-sensitive, but can be made insensitive by setting $caseSensitive to false.
 * @method static bool endsWith(string $subject,string $substring,bool $caseSensitive) Returns true if the string ends with $substring, false otherwise. By default, the comparison is case-sensitive, but can be made insensitive by setting $caseSensitive to false.
 ...
 * @method static bool contains(string $subject,string $needle,bool $caseSensitive) Returns true if the string contains $needle, false otherwise. By default the comparison is case-sensitive, but can be made insensitive by setting $caseSensitive to false.
